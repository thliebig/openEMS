...
# The energy end criteria is otherwise re-evaluated on a wall-clock schedule, so a
# faster machine runs further before it stops and the runs are not comparable.
